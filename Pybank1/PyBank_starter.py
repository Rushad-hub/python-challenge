...
file_to_load = os.path.join("Pybank1", "Resources", "budget_data.csv")  # Input file path
file_to_output = os.path.join("Pybank1", "analysis", "budget_analysis.txt")  # Output file path
