...
candidates = []  # List to store the names of the candidates
candidate_votes = {}  # Dictionary to store the votes each candidate received
...
with open(file_to_load) as election_data:
    ...
    for row in reader:
        ...
        if candidate_name not in candidates:
            candidates.append(candidate_name)  # Add the candidate's name to the list
            candidate_votes[candidate_name] = 0  # Initialize candidate vote count
